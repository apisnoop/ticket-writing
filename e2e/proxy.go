...
var _ = SIGDescribe("Proxy", func() {
	...
	ginkgo.Context("version "+version, func() {
		...
		*/
		...
		ginkgo.It("A set of NamespacedPodProxy endpoints return a valid set of responses", func() {
			ns := f.Namespace.Name
			...
			// Verify 301 redirect from .../proxy to .../proxy/
			httpVerbs := []string{"GET", "HEAD"}
			...
			// Verify 200 response from .../proxy
