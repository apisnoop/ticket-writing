...
** Test the functionality in Go
   ...
   Found DaemonSet test-ds-xzhs5 in namespace default with labels: map[string]string{"test-static":"true"}
   ...
   DaemonSet test-ds-xzhs5 created
   watching for the DaemonSet to be added
   ...
   Observed event: MODIFIED
   Observed event: MODIFIED
   Found DaemonSet test-ds-xzhs5 in namespace default with labels: map[test-resource:updated test-static:true]
   DaemonSet test-ds-xzhs5 deleted
   [status] complete
   #+end_src
