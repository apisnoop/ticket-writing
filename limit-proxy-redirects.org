#+title: Bug: Limit Apiserver Proxy Redirects



*What happened*:

As part of creating an e2e test for [[https://github.com/kubernetes/kubernetes/pull/94786][Pod ProxyOptions endpoints]], it was found that the apiserver
proxy server is processing a blank redirect for any [[https://github.com/kubernetes/kubernetes/blob/4b24dca228d61f4d13dcd57b46465b0df74571f6/staging/src/k8s.io/apimachinery/pkg/util/proxy/upgradeaware.go#L210][method call]] for 21 endpoints across pods, services and nodes.
...
- [[https://github.com/kubernetes/kubernetes/issues/4958][Apiserver proxy requires a trailing slash #4958]]
