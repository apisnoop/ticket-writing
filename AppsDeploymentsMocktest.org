...
**** Questions:
- In the Golang test setting  ~  config.UserAgent = "live-test-writing" ~
- What user agent is operating when doing kubeclt commands?
- How can these the kubeclt results be seen in APISnoop?
- Can the useragent be configured for kubeclt commands?
