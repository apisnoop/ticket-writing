...
- [[https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#scaling-a-deployment][Scaling a Deployment]]
...
-rw-rw-r--  1 riaan riaan    404 Dec 10 11:07 deployment_test.yaml
#+end_example
...
*** 3. Scale the Deployment - THIS HIT THE patchAppsV1NamespacedDeploymentScale ENDPOINT
...
*** Count and clean out audit events
...
* Thoughts on where to look for more clues

  readAppsV1NamespacedStatefulSetScale and replaceAppsV1NamespacedStatefulSetScale is confromance tested:
 https://github.com/kubernetes/kubernetes/blob/master/test/e2e/apps/statefulset.go#L848-L872
