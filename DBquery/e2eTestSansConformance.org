...
#+begin_src sql-mode
  ...
  -- where test_hit = 'false'
  -- and endpoint ilike '%PriorityClass%' limit 5;
  where endpoint ilike '%PriorityClass%' limit 5;
...
-------------------------------------------+---------+--------
 ...
 deleteSchedulingV1CollectionPriorityClass | 1.14.0  | t
 deleteSchedulingV1PriorityClass           | 1.14.0  | t
 listSchedulingV1PriorityClass             | 1.14.0  | t
 patchSchedulingV1PriorityClass            | 1.14.0  | t
 readSchedulingV1PriorityClass             | 1.14.0  | t
 replaceSchedulingV1PriorityClass          | 1.14.0  | t
(7 rows)
