...
kubectl delete ns app-deployment-tests
#+end_src
...
--------------------------------------+--------------------------------------------------
 ...
 deleteAppsV1NamespacedDeployment     | kubectl/v1.19.4 (linux/amd64) kubernetes/d360454
 ...
 replaceAppsV1NamespacedDeployment    | kubectl/v1.19.4 (linux/amd64) kubernetes/d360454
(8 rows)
